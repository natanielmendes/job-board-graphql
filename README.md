...
- Graphql queries to pull data (jobs, users and companies) from these files.
- Graphql mutations tfor adding more entries (jobs / users / companies) into these files.
